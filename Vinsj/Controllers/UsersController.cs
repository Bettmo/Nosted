...
namespace Vinsj.Controllers
{
    ...
    public class UsersController : Controller
    {
        ...
        public IActionResult Index(string? email)
        {
            ...
            if (email != null)
            {
                ...
                if (currentUser != null)
                {
                    ...
                    model.IsAdmin = userRepository.IsAdmin(currrentUser.Email);
                }
            }
        ...
        public IActionResult Save(UserViewModel model)
        {
            ...
            if (userRepository.GetUsers().FirstOrDefault(x =>
                    x.Email.Equals(newUser.Email, StringComparison.InvariantCultureIgnoreCase)) != null)
